...
void launch_no_sc() {
	...
	//""D:\\SteamLibrary\\steamapps\\common\\Grand Theft Auto V\\GTA5.exe\" -skipPatcherCheck @args.txt @commandline.txt -enableCrashpad -useSteam -steamAppId=271590 -scCommerceProvider = 4"
		...
		auto cmdline = R"("D:\SteamLibrary\steamapps\common\Grand Theft Auto V\GTA5_163.exe" -skipPatcherCheck @args.txt @commandline.txt -off-screen-rendering-enabled -enableCrashpad -useSteam -steamAppId=271590 -scCommerceProvider = 4")";
		
		auto mata = std::string(cmdline);
		std::wstring tactu(mata.begin(), mata.end());

		auto result = CreateProcessW(L"D:\\SteamLibrary\\steamapps\\common\\Grand Theft Auto V\\GTA5_163.exe", tactu.data(), NULL, NULL, FALSE, CREATE_SUSPENDED, 0x0000000000000000, L"D:\\SteamLibrary\\steamapps\\common\\Grand Theft Auto V", (LPSTARTUPINFOW)(&StartupInfo), &ProcessInformation);
